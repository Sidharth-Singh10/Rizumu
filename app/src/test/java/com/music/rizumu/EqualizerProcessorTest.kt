...
import com.music.rizumu.playback.EqualizerProcessor
import com.music.rizumu.playback.manualCurve
import com.music.rizumu.playback.toneCurve
...
class EqualizerProcessorTest {
    ...
    /**
     * The two end bands are shelves, not bells — see [com.music.rizumu.playback.FilterKind].
