...
import com.music.rizumu.data.canvas.CanvasCache
import com.music.rizumu.data.canvas.SpotifyToken
import com.music.rizumu.playback.AudioCache
import com.music.rizumu.playback.LastPlayed
...
import com.music.rizumu.data.stats.ArtistFacts
...
class RizumuApplication : Application(), SingletonImageLoader.Factory {
