...
import com.music.rizumu.data.lyrics.translationLanguageName
...
import com.music.rizumu.ui.components.languageDisplayNameRes
...
import com.music.rizumu.ui.performance.supportedPerformanceRefreshRates
import com.music.rizumu.data.model.Account
...
import com.music.rizumu.playback.AudioOutputStatus
import com.music.rizumu.data.settings.AutomixPerformanceMode
import com.music.rizumu.R
import com.music.rizumu.data.sources.DeviceCodecs
import com.music.rizumu.data.settings.AudioQuality
import com.music.rizumu.data.settings.DownloadQuality
import com.music.rizumu.data.settings.PrimaryLibrary
import com.music.rizumu.data.settings.ThemeMode
import com.music.rizumu.data.stats.Backup
import com.music.rizumu.playback.AudioCache
import com.music.rizumu.ui.player.fullBleedArtworkAvailable
...
fun SettingsScreen(
    ...
    Column(
        ...
        SearchableSettingsGroup(search, header = stringResource(R.string.audio_quality)) {
            ...
            // one with a reason under it is the difference between "Rizumu
        ...
        SearchableSettingsGroup(search, header = stringResource(R.string.downloads)) {
            ...
            row(exportDownloadsTitle, "music folder", divided = false) {
                SettingsSubRow(
                    ...
                    subtitle = "Music/Rizumu".takeIf { exportDownloads },
                )
            }
        }
        ...
        SearchableSettingsGroup(search, header = stringResource(R.string.playback)) {
            ...
            // Dolby or Dirac panel has something Rizumu cannot reproduce and
        ...
        Text(
            text = buildAnnotatedString {
                ...
                withLink(LinkAnnotation.Url("https://github.com/Sidharth-Singh10/Rizumu", linkStyles)) {
                    append("GitHub")
                }
                append("  ")
                withLink(LinkAnnotation.Url("https://github.com/Sidharth-Singh10", linkStyles)) {
                    append("Developer")
                }
                append("  ")
