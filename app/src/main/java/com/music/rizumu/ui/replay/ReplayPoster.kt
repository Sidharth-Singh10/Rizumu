...
private fun drawHeader(
    ...
    canvas.drawText("Rizumu", POSTER_W - MARGIN, 132f, brand)
    ...
    val wordWidth = brand.measureText("Rizumu")
...
private fun drawFooter(canvas: Canvas, context: Context, type: Fonts) {
    canvas.drawText(
        context.getString(R.string.counted_on_device_with_rizumu),
        MARGIN,
        POSTER_H - 64f,
...
/**
 * The Rizumu mark, baseline-aligned with the word beside it.
 *
