...
import com.music.rizumu.data.sources.addon.DetectedFormat
import com.music.rizumu.data.sources.addon.SourceFormats
...
object SourceRegistry {
     ...
     * file is worth is [DownloadQuality][com.music.rizumu.data.settings.DownloadQuality]'s
     * question, and when it may be fetched is
     * [AppSettings.wifiOnlyDownloads][com.music.rizumu.data.settings.AppSettings.wifiOnlyDownloads]'s.
     */
     ...
     * see [SourcesScreen][com.music.rizumu.ui.screens.SourcesScreen].
     */
     ...
     *
     * Packed into the existing [Song.videoId][com.music.rizumu.data.model.Song.videoId]
