 ...
 * `next`-endpoint fetches, [ChunkedDataSource][com.music.rizumu.playback.ChunkedDataSource]
 * and [AudioCache][com.music.rizumu.playback.AudioCache]'s multi-megabyte
