...
enum class SourceKind(
     ...
     * [AudioCache][com.music.rizumu.playback.AudioCache], which speaks video
     ...
     * [SourceRegistry.reorderAddons][com.music.rizumu.data.sources.SourceRegistry.reorderAddons].
