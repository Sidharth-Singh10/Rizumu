...
/**
 * Rizumu ships as a sideloaded APK off GitHub Releases rather than through
...
object AppUpdateChecker {
    ...
    private const val LATEST_RELEASE_URL =
        "https://api.github.com/repos/Sidharth-Singh10/Rizumu/releases/latest"
    ...
    suspend fun downloadApk(context: Context): Unit = withContext(Dispatchers.IO) {
        ...
        runCatching {
            ...
            val target = File(dir, "rizumu-${info.version}.apk")
