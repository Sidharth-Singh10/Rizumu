package com.music.rizumu.data.canvas
 ...
 * [CanvasArtworkPlayer][com.music.rizumu.ui.player.CanvasArtworkPlayer].
 *
...
object CanvasCache {
    ...
    /** Opened once per process, alongside [com.music.rizumu.playback.AudioCache.init]. */
     ...
     * choice [com.music.rizumu.playback.AudioCache] makes for audio.
     */
