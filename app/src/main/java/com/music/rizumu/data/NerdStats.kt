...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.music.rizumu.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun sourceFor(mediaId: String?): String? {
        ...
        return sources[key]
            ?: com.music.rizumu.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.music.rizumu.playback.PlaybackService] — which the
     ...
     *
     * @see com.music.rizumu.playback.QualityUpgrade.forgetLastSession for the
