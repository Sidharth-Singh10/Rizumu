...
object SourceResolver {
    ...
    /**
     * @param uri a `rizumu://source?...` URI as built by [SourceRegistry.trackUri].
     ...
     * [toMediaItem][com.music.rizumu.playback.toMediaItem].
     */
     ...
     * playback as `rizumu://watch?v=…` and never passes through [resolve].
     ...
     * [StreamChoice][com.music.rizumu.playback.StreamChoice] before caching a
     ...
     * plays lossy for the rest of its length, because [QualityUpgrade][com.music.rizumu.playback.QualityUpgrade]
     ...
     * directly — see
     * [resolveForDownload][com.music.rizumu.data.innertube.StreamResolver.resolveForDownload]
     ...
     *
     * [DownloadQuality.LOSSLESS][com.music.rizumu.data.settings.DownloadQuality.LOSSLESS]
     * and [DownloadQuality.HIGH][com.music.rizumu.data.settings.DownloadQuality.HIGH];
     * not [DownloadQuality.STANDARD][com.music.rizumu.data.settings.DownloadQuality.STANDARD].
     ...
     * the live lookup [QualityUpgrade][com.music.rizumu.playback.QualityUpgrade]
     ...
     * [AudioCache][com.music.rizumu.playback.AudioCache] decide how to treat
     ...
     * [PlaybackService][com.music.rizumu.playback.PlaybackService]'s
