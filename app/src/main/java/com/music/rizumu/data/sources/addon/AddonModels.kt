 ...
 * [module][com.music.rizumu.data.sources.module] rather than inside it —
...
data class AddonManifest(
     ...
     * parameters on every request; Rizumu has no such form, so it sends the
     ...
     * [AddonSource][com.music.rizumu.data.sources.AddonSource] falls back to
 ...
 * [MusicSource][com.music.rizumu.data.sources.MusicSource] is asked for
 ...
 * [StreamContainer][com.music.rizumu.playback.StreamContainer] is told
...
data class AddonStream(
     ...
     * failure [StreamContainer][com.music.rizumu.playback.StreamContainer]
     * exists to describe.
     *
