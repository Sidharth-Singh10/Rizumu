package com.music.rizumu.data.sources.module
 ...
 * [SourceRegistry][com.music.rizumu.data.sources.SourceRegistry] never
 ...
 *
 * Ported from Convx's `ModuleManager`, adapted to use Rizumu's shared
...
class ModuleManager {
     ...
     *
     * Concurrent because [ModuleSource.search][com.music.rizumu.data.sources.ModuleSource.search]
    ...
    private companion object {
         ...
         * [TrackMatcher][com.music.rizumu.data.sources.TrackMatcher] one —
         ...
         * trade [StreamChoice][com.music.rizumu.playback.StreamChoice] makes,
