package com.music.rizumu.data.model
...
data class Song(
    ...
    /** A premium rendition marker recorded by Rizumu for its Downloads list. */
     ...
     * that need it — see [com.music.rizumu.playback.toMediaItem].
     */
...
data class LibraryPage(
     ...
     * [com.music.rizumu.data.LikeState]; never stored as page state.
     */
...
data class DetailPage(
     ...
     * added — see [com.music.rizumu.data.innertube.InnertubeParser.parsePlaylistShelf].
