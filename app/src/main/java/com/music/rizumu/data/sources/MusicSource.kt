 ...
 * [StreamResolver][com.music.rizumu.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.music.rizumu.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.music.rizumu.playback.QualityUpgrade.lookAgain].
     ...
     * [QualityUpgrade][com.music.rizumu.playback.QualityUpgrade]) can leave
 ...
 * [AppSettings][com.music.rizumu.data.settings.AppSettings] and is turned
