 ...
 * signing out of Rizumu forgets the cookie the app makes requests with, and
...
object BrowserSession {
    ...
    fun clearGoogleCookies() {
        ...
        val manager = runCatching { CookieManager.getInstance() }.getOrElse {
            Log.w("Rizumu", "no cookie manager to clear: ${it.message}")
            return
        }
        var cleared = 0
        ...
        Log.d("Rizumu", "cleared $cleared browser cookies for Google")
    }
