...
import com.music.rizumu.data.settings.SmartAnalysis
import com.music.rizumu.data.settings.TrackAnalysisState
import com.music.rizumu.data.settings.TransitionWindow
import com.music.rizumu.playback.smart.CrossfadeMode
import com.music.rizumu.playback.smart.TrackAnalysis
import com.music.rizumu.playback.smart.TransitionStyle
import com.music.rizumu.playback.smart.TransitionTrackInfo
import com.music.rizumu.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.music.rizumu.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.music.rizumu.playback.smart.TransitionPlan],
     ...
     * ([com.music.rizumu.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.music.rizumu.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.music.rizumu.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.music.rizumu.playback.smart.TrackAnalyzer.request] as the next
    ...
    /** Rizumu doesn't carry album metadata on [MediaMetadata] yet, so [TransitionTrackInfo.album] stays blank. */
