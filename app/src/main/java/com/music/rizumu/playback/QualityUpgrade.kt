 ...
 *
 * The queue holds `rizumu://watch?v=…` URIs that
...
object QualityUpgrade {
     ...
     *   [PlaybackService.audioFormatFor][com.music.rizumu.playback.PlaybackService].
     ...
     * [PlaybackService.upgradeQualityNow][com.music.rizumu.playback.PlaybackService].
     *
