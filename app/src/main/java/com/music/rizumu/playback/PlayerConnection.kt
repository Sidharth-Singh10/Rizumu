 ...
 */
private const val EXTRA_FROM_AUTOPLAY = "Rizumu.fromAutoplay"

/** @see Song.radioName */
private const val EXTRA_RADIO_NAME = "Rizumu.radioName"

/** @see Song.playbackSource */
private const val EXTRA_PLAYBACK_SOURCE = "Rizumu.playbackSource"
private const val EXTRA_PLAYBACK_SOURCE_TYPE = "Rizumu.playbackSourceType"
private const val EXTRA_PLAYBACK_SOURCE_ID = "Rizumu.playbackSourceId"
 ...
 */
private const val EXTRA_ARTIST_ID = "Rizumu.artistId"
private const val EXTRA_ALBUM_ID = "Rizumu.albumId"
...
/** @see Song.localPath */
private const val EXTRA_LOCAL_PATH = "Rizumu.localPath"
 ...
 */
private const val EXTRA_DURATION = "Rizumu.durationText"
private const val EXTRA_EXPLICIT = "Rizumu.explicit"
private const val EXTRA_IS_VIDEO = "Rizumu.isVideo"
private const val EXTRA_VIDEO_ORIGIN = "Rizumu.isVideoOrigin"

/** Set only on the replacement item produced by [QualityUpgrade]. */
const val EXTRA_QUALITY_UPGRADED = "Rizumu.qualityUpgraded"
 ...
 * terms [com.music.rizumu.data.sources.TrackMatcher] compares recordings on.
 *
...
fun Song.toMediaItem(): MediaItem {
    ...
    val uriString = offlineUri ?: when {
        ...
        // reach.
        else -> "rizumu://watch?v=$videoId${matchQuery()}"
    }
...
private fun Song.directYouTubeUri(): String =
    "rizumu://watch?v=$videoId${matchQuery()}&$DIRECT_YOUTUBE_PARAMETER=1&q=original"
 ...
 * — see [com.music.rizumu.data.TrackLog.about].
 *
