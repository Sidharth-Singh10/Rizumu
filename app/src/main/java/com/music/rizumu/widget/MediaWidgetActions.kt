package com.music.rizumu.widget
...
import com.music.rizumu.playback.PlaybackService
 ...
 * from [rememberMediaController][com.music.rizumu.playback.rememberMediaController].
 *
...
class MediaWidgetActions : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.music.rizumu.widget.TOGGLE"
        const val ACTION_NEXT = "com.music.rizumu.widget.NEXT"
        const val ACTION_PREVIOUS = "com.music.rizumu.widget.PREVIOUS"
