 ...
 * connecting one means starting [PlaybackService][com.music.rizumu.playback.PlaybackService]
 * just to find out what to draw. So the service writes here whenever the answer
 * changes ([publishWidgetState][com.music.rizumu.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
        ...
        private fun prefs(context: Context) =
            context.getSharedPreferences("rizumu_widget", Context.MODE_PRIVATE)
