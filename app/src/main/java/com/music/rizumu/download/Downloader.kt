 ...
 *    the same finding [ChunkedDataSource][com.music.rizumu.playback.ChunkedDataSource]
 *    exists for.
...
object Downloader {
     ...
     *    URL — see [SourceStream.headers][com.music.rizumu.data.sources.SourceStream.headers]
