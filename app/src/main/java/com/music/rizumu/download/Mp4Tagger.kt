...
import com.music.rizumu.data.lyrics.WORD_LYRICS_FIELD
...
object Mp4Tagger {
     ...
     * file — see [EmbeddedLyrics][com.music.rizumu.data.lyrics.EmbeddedLyrics],
    ...
    private const val MEAN = "com.music.rizumu"
