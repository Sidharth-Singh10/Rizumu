 ...
 * Copyright (C) 2026 Kushagra Singh (Rizumu adaptation)
 *
 * Orchard's original source is licensed under the GNU Affero General Public
 * License, version 3 or later. Per AGPLv3 section 13, this file is combined
 * here into Rizumu -- a work licensed under the GNU General Public
...
Java_com_music_rizumu_playback_smart_VocalSpectrogram_nativeCompute(
    JNIEnv* env,
    jclass /* clazz */,
    jfloatArray left,
    jfloatArray right,
  ...
  const rizumu::smart::VocalSpectrogram spectrogram =
      rizumu::smart::ComputeVocalSpectrogram(channels, sample_rate);
...
Java_com_music_rizumu_playback_smart_VocalSpectrogram_nativeBins(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(rizumu::smart::kVocalSpectrogramBins);
}

JNIEXPORT jdouble JNICALL
Java_com_music_rizumu_playback_smart_VocalSpectrogram_nativeSampleRate(
    JNIEnv* /* env */, jclass /* clazz */) {
  return rizumu::smart::kVocalSpectrogramSampleRate;
}

JNIEXPORT jint JNICALL
Java_com_music_rizumu_playback_smart_VocalSpectrogram_nativeHop(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(rizumu::smart::kVocalSpectrogramHop);
}

JNIEXPORT jint JNICALL
Java_com_music_rizumu_playback_smart_VocalSpectrogram_nativeFftSize(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(rizumu::smart::kVocalSpectrogramFft);
}
